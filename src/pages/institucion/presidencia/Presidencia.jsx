...
const Presidencia = () => {
  ...
  return (
    <>
      ...
      {/* TracingBeam envuelve todo el contenido principal */}
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pt-0">
          {/* Hero section con Boxes */}
          <div className="relative w-full overflow-hidden bg-slate-900 flex flex-col items-center justify-center min-h-[450px] md:min-h-[550px] mb-16">
            {/* Fondo con boxes */}
            ...
            {/* Contenido principal */}
            <div className="relative z-20 w-full max-w-7xl px-5 md:px-8 py-16 text-center">
              <motion.div
                ref={titleRef}
              ...
              >
                <motion.h1
                  ...
                  className="
                    ...
                    uppercase tracking-tight drop-shadow-2xl dark:from-blue-300 dark:via-purple-300 dark:to-indigo-300
                  "
                >
                ...
                <motion.div
                  ...
                  className="h-1.5 bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500 rounded-full mx-auto mb-8 shadow-lg"
                />
                ...
                >
                  <h2 className="text-2xl md:text-3xl font-semibold text-white mb-3 drop-shadow-lg">
                    Fundación Cultural del Banco Central de Bolivia
                  </h2>
                  <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                    Liderazgo y visión para la promoción cultural en Bolivia
                  </p>
                </motion.div>
              </motion.div>
            </div>
...
<TracingBeam className="w-full px-4">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 -mt-8 md:-mt-12">
            ...
            >
              ...
              <div className="mb-10 relative overflow-hidden">
                ...
                <motion.div
                  ...
                  className="absolute top-0 bottom-0 left-0 right-0 bg-blue-400 z-10"
                />
              </div>

              {/* Contenido del texto con animaciones escalonadas */}
              <motion.div
                variants={staggerContainer}
                initial="hidden"
                animate={contentControls}
                className="space-y-3 text-gray-700 dark:text-gray-300 text-lg leading-relaxed pl-6 md:pl-8 relative"
              >
              ...
              >
                ...
                <div className="relative overflow-hidden mb-6">
                  ...
                  <motion.h3
                    ...
                    animate={bioControls}
                    transition={{ duration: 0.6, delay: 0.2 }}
                    className="text-xl md:text-2xl font-bold text-blue-600 dark:text-blue-400 mb-4"
                  >
                  ...
                  <motion.div
                    ...
                    animate={bioControls}
                    transition={{ duration: 0.7, ease: "easeIn", delay: 0 }}
                    className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-r from-blue-500 to-amber-400 z-10"
                  />
                </div>
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1 }}
                  className="mt-8 p-5 bg-gradient-to-r from-blue-50 to-amber-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl border border-blue-200 dark:border-blue-800/30"
                >
            ...
            <motion.div
              ...
              className="text-center p-6 md:p-8 bg-gradient-to-r from-blue-50 to-amber-50 dark:from-blue-800/20 dark:via-purple-800/20 dark:to-blue-800/20 rounded-2xl border border-blue-200 dark:border-blue-800/30 max-w-3xl mx-auto"
            >
          ...
          {/* Repositorios Nacionales fuera del TracingBeam */}
