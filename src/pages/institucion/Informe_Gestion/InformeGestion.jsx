            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-lg">
                  Memorias institucionales y reportes de gestión de la Fundación Cultural del BCB
                </p>
              </div>
  ...
  <div className="relative w-full h-full" style={{ transformStyle: "preserve-3d" }}>
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col p-6 text-center ">
        ...
        {/* Título */}
        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-3 leading-tight text-center">
          {informe.nombre}
        </h3>
